...
exports.handler = async (event) => {
  // Netlify's automatic Blobs credential injection has a known platform bug
  // on some newly-created sites (MissingBlobsEnvironmentError even with
  // correct setup). Passing siteID + token explicitly works around it.
